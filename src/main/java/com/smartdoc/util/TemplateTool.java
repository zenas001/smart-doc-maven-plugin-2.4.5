...
public class TemplateTool {
    ...
    private static String getOutFilePath(final String outPath, final String outFileName, String suffix) {
        return outPath.endsWith("\\") ? outPath.concat(outFileName) : outPath.concat("\\").concat(outFileName).concat(suffix);
    }

//    public static void main(String[] args) {
//        TemplateTool.generateImportTemplate(new HashMap<>(), "utils.ftl", "D:\\openSourceProject\\smart-doc-maven-plugin-2" +
